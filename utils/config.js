...
export const CSS_CLASSES = {
  ...
  COLOR_TILE_THEME_DARK: "color-tile--theme-dark",
  COLOR_TILE_THEME_LIGHT: "color-tile--theme-light",
  ...
  MODAL_HEADER_THEME_DARK: "modal-header--theme-dark",
  MODAL_HEADER_THEME_LIGHT: "modal-header--theme-light",
