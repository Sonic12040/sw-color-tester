...
export class URLParameterManager {
  ...
  /**
   * Get a single string parameter from the URL
   * @param {string} paramName - The name of the URL parameter
   * @returns {string|null} The parameter value, or null if it doesn't exist
   */
  static getStringParameter(paramName) {
    const params = new URLSearchParams(globalThis.location.search);
    return params.get(paramName);
  }

  /**
   * Set a single string parameter in the URL
   * @param {string} paramName - The name of the URL parameter
   ...
   * @param {string} paramName - The name of the URL parameter to remove
   * @param {boolean} replaceState - Whether to replace the current history state (default: true)
   */
  static removeParameter(paramName, replaceState = true) {
    const params = new URLSearchParams(globalThis.location.search);
    params.delete(paramName);
